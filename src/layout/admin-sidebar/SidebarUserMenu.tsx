...
export const SidebarUserMenu: React.FC = () => {
  ...
  return (
    ...
    >
      <DropdownMenu>
        <DropdownMenuTrigger className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-all duration-200 group">
        ...
        <DropdownMenuContent align="end" className="w-56 bg-white border border-gray-200 shadow-lg">
          ...
          <DropdownMenuItem onClick={handleLogout} className="cursor-pointer text-red-600 group">
            <LogOut className="mr-3 h-4 w-4 group-hover:text-red-700 transition-colors" />
