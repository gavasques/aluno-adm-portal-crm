    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Agende e gerencie sessões de mentoria individuais</p>
        </div>
        <Button>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">Comece agendando sua primeira sessão individual.</p>
            <Button>
              <Plus className="h-4 w-4 mr-2" />
