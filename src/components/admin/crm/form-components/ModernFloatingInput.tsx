...
interface ModernFloatingInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label: string;
  error?: string;
}

const ModernFloatingInput = forwardRef<HTMLInputElement, ModernFloatingInputProps>(
...
ModernFloatingInput.displayName = 'ModernFloatingInput';
